...
def main(args):
    ...
    print(f"✅ Found {len(all_results)} documents across all shards")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--top_k_per_shard", type=int, default=2, help="Number of docs to retrieve per shard")
    parser.add_argument("--top_n_for_answer", type=int, default=5, help="Number of top docs to use for answer generation")
